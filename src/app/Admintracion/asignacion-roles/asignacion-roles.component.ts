  ...
  findDocenteAll() {
    forkJoin({
      ...
      next: ({ docentes, funciones, nombresFunciones }) => {
        //console.log("Inicial: Funciones", funciones);
        //console.log("Inicial: Docentes", docentes);
        //console.log("Inicial: NombresFunciones", nombresFunciones);
        ...
        this.docentes = docentesConRol.filter((docente: Docente) => docente.nombreFuncion !== 'Director');
      },
